<template>
  <div class="app-container">
    ...
    <el-row :gutter="10">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-has-permi="['devices:brands:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-has-permi="['devices:brands:update']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-has-permi="['devices:brands:delete']"
        >删除</el-button>
      </el-col>
    </el-row>
    ...
    <el-table v-loading="$store.state.app.loading" :data="dataList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="设备类型" align="center" :formatter="deviceFormatter" prop="type" />
...
<script>
import { getBrand, getBrandById, addBrand, updateBrand, delBrand } from '@/api/admin/device/brand'
...
export default {
  ...
  methods: {
    ...
    getList () {
      getBrand(this.queryParams).then(res => {
